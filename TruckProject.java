...
public class TruckProject {
	...
	public static void main(String[] args) throws InterruptedException {
      ...
      //First name
        ...
        //Last name
        driver.findElement(By.id("lastname")).sendKeys("Mathane");
        
        //DOB
        driver.findElement(By.id("birthdate")).sendKeys("03/03/2002");
        
        
       //Gender
        WebElement gender=driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[2]/div[4]/p"));
        gender.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[2]/div[4]/p/label[2]")).click();
        
        //Street Address
       driver.findElement(By.id("streetaddress")).sendKeys("Teacher colony,Chandrapur");
    ...
    WebElement actCoverE=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[4]/td[3]"));
     ...
     // confirmpassword
      ...
      File srcFile=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		try {
			FileUtils.copyFile(srcFile, new File("D:\\SEED_INFOTECH\\Test_Case\\ScreenShot\\Truck.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
